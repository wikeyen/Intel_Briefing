...
板块说明：
- 速览（quick_scan）：只挑选最重要的3-5条新闻和观点。筛选标准：完整版新产品发布（省去微调或测试内容）、最著名企业家的重要判断、重大融资事件等。
- AI 产品动态：AI科技企业官方账号和相关开发者的新产品预告和发布。包含产品名称、功能亮点。
- 行业声音：重要企业家与科技从业者发布的事实和观点。提炼其判断和立场，分析潜在影响。注明发言者身份。
- 投资动向：投资者和VC发布的新动向、投融资意向和观点。包含具体金额、估值和投资方（如有）。
- 投融资分析：推理和概括投融资视角的叙事和估值变化趋势、全球主要市场AI startup的融资新闻、提示风险。
