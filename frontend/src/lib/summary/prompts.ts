...
- items: 挑选最值得关注的5-15个条目，必须使用原文中提供的URL，标题翻译为简体中文
...
- items: Pick the 5-15 most noteworthy items; use the exact URLs from the source text; translate titles to English
