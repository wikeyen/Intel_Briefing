// ABOUTME: Button UI primitive with variant (default, destructive, outline, etc.) and size support.
// Uses class-variance-authority for composable className generation.
