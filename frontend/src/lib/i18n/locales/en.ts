...
const en: TranslationDict = {
  ...
  'sensor.no_accounts': 'No accounts configured to follow',
  'sensor.done': 'Done',
  ...
  'sensor.desc.x_accounts': 'Posts from monitored X accounts',
  'sensor.desc.bluesky_accounts': 'Posts from monitored Bluesky accounts',
  'sensor.desc.bluesky_topics': 'Keyword and hashtag search on Bluesky',
  'sensor.desc.mastodon_accounts': 'Posts from monitored Mastodon accounts',
  'sensor.desc.mastodon_topics': 'Hashtag search on Mastodon',
  'sensor.desc.mastodon_trends': 'Trending posts on Mastodon',
  'sensor.desc.rss_blogs': 'Blog and other RSS/Atom feed subscriptions',
  ...
  'sources.x_scraper_provider': 'Scraper',
  ...
  'sources.workflow_summary_prompt': 'Summary',
  'sources.workflow_trend_prompt': 'Trend analysis',
  'sources.workflow_topic_prompt': 'Topic analysis',
  'sources.workflow_social_prompt': 'Social analysis',
  'sources.workflow_using_default': 'Using default',
